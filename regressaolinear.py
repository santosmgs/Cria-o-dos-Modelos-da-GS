# Regressão Linear Homens Modelo 1
...
# Escolhendo a variável demográfica para o Modelo 1
variavel_demografica = 'Homens'

# Criação do modelo de regressão linear
modelo = LinearRegression()
modelo.fit(anos, data[variavel_demografica])
...
plt.title(f'Regressão Linear para {variavel_demografica}')
plt.xlabel('Ano')
plt.ylabel('Porcentagem')
plt.show()

print(f"Previsão para o próximo ano: {previsao[0]:.2f}%")